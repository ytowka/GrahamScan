...
*/
    ...
    private static OnMouseClick mouseClickListener = null;

    public static void setOnMouseClick(OnMouseClick onMouseClick){
    ...
    public void mouseClicked(MouseEvent e) {
        if(mouseClickListener != null){
            mouseClickListener.onClick(userX(e.getX()), userY(e.getY()));
        }
    }
